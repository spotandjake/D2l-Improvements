...
const defaultCompilerOptions = {client: true, strict: true, compileDebug:false};
...
const loadStylesTo = (code, tplFilePath) =>
  code.replace(linkTagRegEx, (match, href) => href && path.extname(href)
